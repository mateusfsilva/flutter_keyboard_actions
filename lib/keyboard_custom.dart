...
/// A widget that allow us to create a custom keyboard instead of the platform
/// keyboard.
...
/// A mixin which help to update the notifier, you must mix this class in case
/// you want to create your own keyboard
mixin KeyboardCustomPanelMixin<T> {
  /// We'll use this notifier to send the data and refresh the widget inside
  /// [KeyboardCustomInput]
